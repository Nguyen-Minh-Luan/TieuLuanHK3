...
public class SpendingWarningServiceImpl implements SpendingWarningService {
        ...
        public SpendingWarningDTO analyze(Long categoryId, TransactionDTO requestDTO) {
                ...
                if (currentMonthFromDB == null)
                        currentMonthFromDB = 0.0;
        ...
        private SpendingWarningDTO analyzeInternal(Long categoryId, double currentMonthTotal) {
                ...
                // ── 2. Lấy lịch sử chi tiêu theo tháng (N tháng trước, không tính tháng hiện
                // tại) ──
        ...
        private SpendingWarningDTO buildWarning(String categoryName, Double currentMonthTotal,
                ...
                return SpendingWarningDTO.builder()
                                ...
                                .currentMonthTotal(currentMonthTotal)
                                .historicalAverage(historicalAverage)
                                .overagePercent(Math.round(overagePercent * 10000.0) / 100.0) // làm tròn 2 chữ số thập
                                                                                              // phân
                                .level(level)
                                .message(message)
                                .build();
